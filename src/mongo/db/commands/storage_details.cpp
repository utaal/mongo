    ...
    namespace {
        ...
        public:
            ...
            bool run(const string& dbname , BSONObj& cmdObj, int, string& errmsg,
                ...
                return run(nsd, extent, subCommand, params, errmsg, result);
            }
        ...
        private:
            ...
            bool analyzeMemInCore(const Extent* ex, AnalyzeParams& params,
                ...
                for (int chunk = 0; chunk < params.numberOfChunks; ++chunk) {
                    ...
                    int pagesInChunk = (chunkLength + pageSize - 1) / pageSize;
            ...
            bool run(const NamespaceDetails* nsd, const Extent* ex, int subCommand,
                ...
                params.numberOfChunks = (params.length + params.granularity - 1) /
                                        params.granularity;
